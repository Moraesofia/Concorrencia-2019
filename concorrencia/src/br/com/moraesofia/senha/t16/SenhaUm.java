...
public class SenhaUm {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ThreadGroup grupo = new ThreadGroup("SenhaHash1-t16");
        byte[] hashDesejada = DatatypeConverter.parseHexBinary(HASH_1);
        ...
        for (EncontraSenha e : senhas) {
            if (e.isEncontrada()) {
                System.out.println("Senha 1 enontrada pela thread: " + e.getNome());
